...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/s-urbaniak/prometheus-adapter/pkg/apis/metrics/v1.ResourceRule":     schema_pkg_apis_metrics_v1_ResourceRule(ref),
		"github.com/s-urbaniak/prometheus-adapter/pkg/apis/metrics/v1.ResourceRuleList": schema_pkg_apis_metrics_v1_ResourceRuleList(ref),
		"github.com/s-urbaniak/prometheus-adapter/pkg/apis/metrics/v1.ResourceRuleSpec": schema_pkg_apis_metrics_v1_ResourceRuleSpec(ref),
...
func schema_pkg_apis_metrics_v1_ResourceRule(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ResourceRule describes a rule for querying resource metrics API results. The name of the resource rule reflects the actual resource, i.e. cpu, memory.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/s-urbaniak/prometheus-adapter/pkg/apis/metrics/v1.ResourceRuleSpec", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_pkg_apis_metrics_v1_ResourceRuleList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ResourceRuleList is a list of ResourceRules.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/s-urbaniak/prometheus-adapter/pkg/apis/metrics/v1.ResourceRule"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/s-urbaniak/prometheus-adapter/pkg/apis/metrics/v1.ResourceRule", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_pkg_apis_metrics_v1_ResourceRuleSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
		...
		Dependencies: []string{
			"github.com/s-urbaniak/prometheus-adapter/pkg/apis/metrics/v1.GroupResource", "k8s.io/apimachinery/pkg/apis/meta/v1.Duration"},
	}
}
